...
\begin{frame}
    ...
    \begin{enumerate}
        ...
        \item بررسی الگوریتم‌های کوانتومی سازگارپذیر مانند الگوریتم تخمین مقدار ویژه و الگوریتم بهینه سازی تخمینی کوانتومی
...
\begin{frame}
    ...
    \begin{enumerate}
        \item پیاده‌سازی الگوریتم حمله در محیط پنی‌لین، و در صورت امکان دستگاه واقعی
        \item حمله به نسخه‌های ساده‌شده بلوک‌رمزها برای تحلیل نتایج اولیه و استخراج زمان‌های همگرایی
...
\begin{frame}
    ...
    \begin{enumerate}
        \setcounter{enumi}{3}
        \item پیاده‌سازی ساختارهای بهینه در فضای پارامترها مانند استفاده از مختصات کروی برای افزایش سرعت همگرایی
